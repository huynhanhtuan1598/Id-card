...
export default function footer() {
  return (
    <div className="MuiBottomNavigation-root jss94 css-de1c49">
      <Link to="/">
        <button
          className="MuiButtonBase-root MuiBottomNavigationAction-root jss95 css-fcyteq home"
          tabIndex="0"
          type="button"
        >
          <svg
          ...
          <span className="MuiBottomNavigationAction-label css-14bcf2k">
            Trang chủ
          </span>
      ...
      <Link to="/form_report">
        <button
          className="MuiButtonBase-root MuiBottomNavigationAction-root jss95 css-fcyteq report"
          tabIndex="0"
          type="button"
      ...
      <Link
        to="/add_contact"
        className="MuiButtonBase-root MuiFab-root MuiFab-circular MuiFab-sizeLarge MuiFab-primary jss96 css-1ifjro9"
        tabIndex="0"
      >
        <svg
          className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv"
      ...
      <Link to="/form_group">
        <button
          className="MuiButtonBase-root MuiBottomNavigationAction-root jss95 css-fcyteq group"
          tabIndex="0"
          type="button"
      ...
      <Link to="/appearance">
        <button
          className="MuiButtonBase-root MuiBottomNavigationAction-root jss95 css-fcyteq backgroup-template"
          tabIndex="0"
          // type="button"
